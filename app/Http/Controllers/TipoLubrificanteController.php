...
class TipoLubrificanteController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('tipo-lubrificante.index', compact('tipolubrificante'));
    }
    ...
    {
        return view('tipo-lubrificante.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('tipo-lubrificante');
    }
    ...
    public function show($id)
    {
        ...
        return view('tipo-lubrificante.show', compact('tipolubrificante'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('tipo-lubrificante.edit', compact('tipolubrificante'));
    }
