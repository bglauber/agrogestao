...
class VeiculoController extends Controller
{
  ...
  */
  public function index(Request $request)
  {
    ...
    if (!empty($keyword)) {
      $veiculo = Veiculo::join('tipo_veiculo', 'veiculo.id', '=', 'contacts.user_id')
      ->where('nome_veiculo', 'LIKE', "%$keyword%")
  ...
  * @return \Illuminate\Http\RedirectResponse|\Illuminate\Routing\Redirector
  */
  public function getTipoVeiculo($id)
  {
    $tipo = TipoVeiculo::find($id);

    return $tipo->nome_tipo_veiculo;
  }
}
